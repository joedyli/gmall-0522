...
public class AttrController {
    ...
    public ResponseVo<List<AttrEntity>> queryAttsByCidAndTypeOrSearchType(@PathVariable("cid")Long cid,
                                                                          @RequestParam(value = "type", required = false)Integer type,
                                                                          @RequestParam(value = "searchType", required = false)Integer searchType
    ){
        List<AttrEntity> attrEntities = this.attrService.queryAttsByCidAndTypeOrSearchType(cid, type, searchType);
